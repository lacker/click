...
sites remain discoverable, expandable, replayable, and within the project's
performance policy.
...
- expansion must produce a surface rewrite backed by a replayed certificate;
- verification must accept the expanded result;
