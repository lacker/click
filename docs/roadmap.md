...
- Permission logic:
  ...
  wrappers over built-in resources and invariant facts. Fractions, persistent
  named resources, implicit open/close search, custom resource-family algebra,
  full heap deallocation semantics, and abstract ownership predicates are still
  future work.
