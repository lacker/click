...
- [Language](reference/language/index.md)
  - [Grammar and operators](reference/language/grammar.md)
  - [Supported C0](reference/language/c0.md)
  - [Limitations and compatibility](reference/language/limitations.md)
- [Tactics](reference/tactics/index.md)
- [Command-line interface](reference/cli/index.md)
  - [`click verify`](reference/cli/verify.md)
...
- [What Click proves](concepts/what-click-proves.md)
- [Files and sidecars](concepts/sidecars.md)
- [Your first proof](concepts/first-proof.md)
...
- [Pure Click functions](concepts/pure-functions.md)
- [Specification state](concepts/spec-state.md)
- [Larger examples](concepts/larger-examples.md)
- [Proof workflow](concepts/proof-workflow.md)
- [Surface Click and Kernel Click](concepts/surface-and-kernel.md)
- [Memory model](concepts/memory-model.md)
- [Proof landscape](concepts/proof-landscape.md)
- [Performance tools](concepts/performance-tools.md)
- [Proof-failure triage](concepts/proof-failure-triage.md)

# Internals

- [Internals](internals/index.md)
- [Architecture](internals/architecture.md)
- [Proof objects](internals/proof-objects.md)
...
- [Technical documentation style](style.md)
