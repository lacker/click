...
| Assertions and facts | Lean/Dafny/F* proof scripts | spec assertion checking | `statement N { assert ... by auto; }`, later `have`, `exact` | `mdtests/count_to_three_loop_invariants.md`, `mdtests/count_to_three_bad_assert.md` |
