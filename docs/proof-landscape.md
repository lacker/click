...
| Intermediate facts | Lean/Dafny/F* proof scripts | pure goals at the current execution frontier | `have ... by { ... }`, `assumption`, `derive` | `mdtests/count_to_three_loop_invariants.md`, `mdtests/count_to_three_bad_assert.md` |
