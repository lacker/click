...
| Proposition syntax | Lean/Isabelle/Dafny/F* specifications | kernel `And`, `Or`, `Not`, `Implies`, `ForAll` propositions | `and`, `or`, `not`, `implies`, `forall` | `mdtests/click_proposition_logic.md` |
