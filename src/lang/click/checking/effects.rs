...
pub(in crate::lang::click) fn prove_effect_clause(
    claim_label: &str,
    path_index: usize,
...
pub(in crate::lang::click) fn prove_effect_clause_exact(
    claim_label: &str,
    path_index: usize,
    execution_pure_facts: &[crate::kernel::ExecutionPureFact],
    available_pure_facts: &[Proposition],
...
pub(in crate::lang::click) fn plan_effect_clause_derivations(
    claim_label: &str,
    path_index: usize,
    execution_pure_facts: &[crate::kernel::ExecutionPureFact],
    available_pure_facts: &[Proposition],
...
pub(in crate::lang::click) fn is_effect_relevant_pointer(pointer: &Pointer) -> bool {
...
pub(in crate::lang::click) struct EvaluatedContractSegment {
    pub(in crate::lang::click) source: ContractSegment,
    pub(in crate::lang::click) base: Pointer,
    pub(in crate::lang::click) start: Bitvector32Term,
    pub(in crate::lang::click) end: Bitvector32Term,
}

pub(in crate::lang::click) fn evaluate_effect_segment(
    parameters: &[syntax::C0Parameter],
    arguments: &[CExpression],
    entry_state: &CState,
    available_pure_facts: &[Proposition],
...
pub(in crate::lang::click) fn evaluate_requirement_segment(
    parameters: &[syntax::C0Parameter],
    arguments: &[CExpression],
    entry_state: &CState,
    segment: &ContractSegment,
...
pub(in crate::lang::click) fn int32_element_index_from_pointer_offset(
