...
pub(in crate::lang::click) struct KernelPropositionLowerer {
...
impl KernelPropositionLowerer {
    pub(in crate::lang::click) fn new(
        values: BTreeMap<String, CValue>,
        array_refs: ClickArrayRefs,
        memory: CMemory,
        predicate_environment: &PredicateEnvironment,
    ...
    pub(in crate::lang::click) fn lower_requirement_proposition(
        &mut self,
    ...
    pub(in crate::lang::click) fn lower_requirement_c_expression(
        &self,
...
pub(in crate::lang::click) fn comparison_proposition(
    left: CValue,
...
pub(in crate::lang::click) fn proposition_as_single_condition(
...
pub(in crate::lang::click) fn conditional_contract_value(
    proposition: &Proposition,
    then_value: CValue,
    else_value: CValue,
...
pub(in crate::lang::click) fn true_proposition() -> Proposition {
    Proposition::ConditionIs(ConditionTerm::Constant(true), true)
}

pub(in crate::lang::click) fn false_proposition() -> Proposition {
    Proposition::ConditionIs(ConditionTerm::Constant(false), true)
}

pub(in crate::lang::click) fn conjunction(left: Proposition, right: Proposition) -> Proposition {
    match (&left, &right) {
...
pub(in crate::lang::click) fn disjunction(left: Proposition, right: Proposition) -> Proposition {
    match (&left, &right) {
...
pub(in crate::lang::click) fn range_membership_proposition(
...
pub(in crate::lang::click) fn bounded_forall_int32(
    variable: Variable,
    start: Bitvector32Term,
    item: Bitvector32Term,
    end: Bitvector32Term,
...
pub(in crate::lang::click) fn bounded_exists_int32(
    name: String,
    variable: Variable,
    start: Bitvector32Term,
    item: Bitvector32Term,
...
pub(in crate::lang::click) fn spec_range_membership_proposition(
...
pub(in crate::lang::click) fn int32_term_value(
    value: CValue,
    label: &str,
...
pub(in crate::lang::click) fn promoted_int32_term(value: &CValue) -> Option<Bitvector32Term> {
    match value {
...
pub(in crate::lang::click) fn concrete_fold_range(
    start: i32,
    end: i32,
...
pub(in crate::lang::click) fn concrete_bound_from_term(
...
pub(in crate::lang::click) fn fold_bound_variable(name: &str, salt: u64) -> Variable {
...
pub(in crate::lang::click) fn symbolic_range_fold_value(
    start: Bitvector32Term,
    end: Bitvector32Term,
    initial: CValue,
    accumulator: &str,
...
pub(in crate::lang::click) fn lower_contract_add(
    left: CValue,
    right: CValue,
) -> Result<CValue, ClickError> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::lang::click) fn lower_contract_subtract(
    left: CValue,
    right: CValue,
) -> Result<CValue, ClickError> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::lang::click) fn lower_contract_multiply(
    left: CValue,
    right: CValue,
) -> Result<CValue, ClickError> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::lang::click) fn lower_contract_divide(
    left: CValue,
    right: CValue,
) -> Result<CValue, ClickError> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::lang::click) fn lower_contract_remainder(
    left: CValue,
    right: CValue,
) -> Result<CValue, ClickError> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::lang::click) fn lower_contract_shift_left(
    left: CValue,
    right: CValue,
) -> Result<CValue, ClickError> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::lang::click) fn lower_contract_shift_right(
    left: CValue,
    right: CValue,
) -> Result<CValue, ClickError> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::lang::click) fn lower_contract_bitwise_binary(
    left: CValue,
    right: CValue,
    operator: &str,
...
pub(in crate::lang::click) fn lower_contract_bitwise_not(
    value: CValue,
) -> Result<CValue, ClickError> {
...
pub(in crate::lang::click) fn bitvector32_add(
...
pub(in crate::lang::click) fn bitvector32_subtract(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> Bitvector32Term {
    match (&left, &right) {
...
pub(in crate::lang::click) fn bitvector32_multiply(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> Bitvector32Term {
    match (&left, &right) {
...
pub(in crate::lang::click) fn bitvector32_divide(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> Result<Bitvector32Term, String> {
    match (&left, &right) {
...
pub(in crate::lang::click) fn bitvector32_remainder(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> Result<Bitvector32Term, String> {
    match (&left, &right) {
...
pub(in crate::lang::click) fn bitvector32_shift_count(right: u32) -> Option<u32> {
    let right = right as i32;
    (0..32).contains(&right).then_some(right as u32)
}

pub(in crate::lang::click) fn bitvector32_shift_left(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> Result<Bitvector32Term, String> {
    match (&left, &right) {
...
pub(in crate::lang::click) fn bitvector32_shift_right(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> Result<Bitvector32Term, String> {
    match (&left, &right) {
...
pub(in crate::lang::click) fn bitvector32_and(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> Bitvector32Term {
    match (&left, &right) {
...
pub(in crate::lang::click) fn bitvector32_or(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> Bitvector32Term {
    match (&left, &right) {
...
pub(in crate::lang::click) fn bitvector32_xor(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> Bitvector32Term {
    match (&left, &right) {
...
pub(in crate::lang::click) fn bitvector32_not(value: Bitvector32Term) -> Bitvector32Term {
    match value {
...
pub(in crate::lang::click) fn signed_less_than(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> ConditionTerm {
    match (&left, &right) {
...
pub(in crate::lang::click) fn signed_less_equal(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> ConditionTerm {
    match (&left, &right) {
...
pub(in crate::lang::click) fn signed_greater_than(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> ConditionTerm {
    match (&left, &right) {
...
pub(in crate::lang::click) fn signed_greater_equal(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> ConditionTerm {
    match (&left, &right) {
...
pub(in crate::lang::click) fn bitvector32_equal(
    left: Bitvector32Term,
    right: Bitvector32Term,
) -> ConditionTerm {
    match (&left, &right) {
