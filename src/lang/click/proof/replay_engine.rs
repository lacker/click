...
pub(super) fn record_certificate_facts_from_replay(
    before: &[Proposition],
    after: &[Proposition],
...
#[allow(clippy::too_many_arguments)]
pub(super) fn execute_internal_proof(
...
pub(super) fn add_proof_branch_path(mut error: ClickError, branch_path: &[String]) -> ClickError {
