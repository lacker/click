...
pub(super) fn lower_outcome_simp_tactics(
    ...
    fn search(
        ...
        if matches!(
            ...
            plan_explicit_strict_then_nonstrict_transitive(&current, premises)
        {
            tactics.extend(suffix);
            return true;
        }
        if matches!(
            ...
            plan_explicit_constant_strict_upper_bound_weakening(&current, premises)
        {
            tactics.extend(suffix);
            return true;
        }
        if matches!(
            ...
            plan_explicit_constant_lower_bound_weakening(&current, premises)
        {
            tactics.extend(suffix);
            return true;
        }
        if matches!(
            ...
            plan_explicit_increment_constant_upper_bound(&current, premises)
        {
            tactics.extend(suffix);
            return true;
        }
