...
use crate::kernel::{
    ...
    CResourceAccessMode, CResourceElement, CResourceSpec, CState, CStatement, CStatementOutcome,
    CType, CValue, ConditionTerm, PathFact, Pointer, PointerOffsetTerm, ProofObligation,
    Proposition, ResourceContext, ResourceContextValidityError, Sort, SpecExpression, SpecMemory,
    SpecProposition, Term, Theorem, Variable, c_function, c_function_entry_state,
