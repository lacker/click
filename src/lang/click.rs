...
use crate::kernel::{
    Bitvector32Term, CCheckedFunctionExecution, CComparisonOperator, CCompositeResourceDefinition,
    ...
    Variable, abstract_c_state_for_join, c_condition_fact_has_memory, c_condition_fact_memories,
