...
pub(in crate::surface) fn evaluate_c_contract_expression(
...
pub(in crate::surface) fn evaluate_contract_memory_load(
    state: &CState,
    pointer: Pointer,
    value_type: CType,
    assumptions: &PureFactContext,
...
pub(in crate::surface) fn evaluate_contract_memory_load_from_memory(
    memory: &CMemory,
    pointer: Pointer,
    value_type: CType,
    assumptions: &PureFactContext,
...
pub(in crate::surface) fn evaluate_contract_memory_load_with_resources(
    memory: &CMemory,
...
pub(in crate::surface) fn c_value_matches_kernel_type(value: &CValue, c_type: CType) -> bool {
    matches!(
        (value, c_type),
...
pub(in crate::surface) fn symbolic_contract_memory_load(
    memory: &CMemory,
    pointer: Pointer,
    value_type: CType,
) -> Result<CValue, String> {
...
pub(in crate::surface) fn evaluate_postcondition_sub(
    left: CValue,
    right: CValue,
) -> Result<CValue, String> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::surface) fn evaluate_postcondition_multiply(
    left: CValue,
    right: CValue,
) -> Result<CValue, String> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::surface) fn evaluate_postcondition_divide(
    left: CValue,
    right: CValue,
) -> Result<CValue, String> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::surface) fn evaluate_postcondition_remainder(
    left: CValue,
    right: CValue,
) -> Result<CValue, String> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::surface) fn evaluate_postcondition_shift_left(
    left: CValue,
    right: CValue,
) -> Result<CValue, String> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::surface) fn evaluate_postcondition_shift_right(
    left: CValue,
    right: CValue,
) -> Result<CValue, String> {
    if let (Some(left_term), Some(right_term)) =
...
pub(in crate::surface) fn evaluate_postcondition_bitwise_binary(
    left: CValue,
    right: CValue,
    operator: &str,
...
pub(in crate::surface) fn evaluate_postcondition_bitwise_not(
    value: CValue,
) -> Result<CValue, String> {
...
pub(in crate::surface) fn evaluate_postcondition_pointer_add(
    left: CValue,
    right: CValue,
