...
pub(in crate::surface::proof) struct CheckedFixedStateTheoremApplication {
    ...
    pub(in crate::surface::proof) function_entry_prerequisite: Option<Proposition>,
    pub(in crate::surface::proof) function_entry_derivation: Option<Theorem>,
}
...
#[allow(clippy::too_many_arguments)]
pub(in crate::surface::proof) fn kernel_standard_theorem_derivation_in_current_state(
    theorem_environment: &TheoremEnvironment,
    application: &TheoremApplication,
    parameters: &[syntax::C0Parameter],
    arguments: &[CExpression],
...
#[allow(clippy::too_many_arguments)]
pub(in crate::surface::proof) fn kernel_standard_theorem_derivation_in_current_state_with_assumptions(
    theorem_environment: &TheoremEnvironment,
    application: &TheoremApplication,
    parameters: &[syntax::C0Parameter],
    arguments: &[CExpression],
