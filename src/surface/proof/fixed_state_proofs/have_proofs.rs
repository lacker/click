...
#[allow(clippy::too_many_arguments)]
pub(in crate::surface::proof) fn prove_have_in_state(
    have: &ProofHave,
    theorem_environment: &TheoremEnvironment,
    claim_label: &str,
    outer_tactic_index: usize,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::surface::proof) fn prove_pure_proposition_in_state(
    proposition: &ClickProposition,
    prelowered_goal: Option<&Proposition>,
    proof: &SourceProof,
    proof_name: &str,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::surface::proof) fn prove_pure_proposition_case_in_state(
    proposition: &ClickProposition,
    prelowered_goal: Option<&Proposition>,
