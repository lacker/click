...
pub(super) use path_facts::{
    ...
    common_pointer_offset_element_width, decide_with_facts, element_count_from_bytes,
    element_index_from_offset, forall_int32, int32_element_count_from_bytes,
    ...
    pointer_byte_offset_from_base, public_execution_pure_facts, signed_const_add,
    solve_builtin_prop, wrap_path_context, wrap_path_context_with_introductions, wrap_proof_facts,
};
