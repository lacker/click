...
pub use schema::{
    CppBinaryOperator, CppCallArgument, CppExport, CppExpression, CppField, CppFieldReference,
    CppFunction, CppFunctionReference, CppInitializer, CppPlace, CppPlaceReference, CppProfile,
    CppRecord, CppSpan, CppStatement, CppType,
};
