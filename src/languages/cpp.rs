...
pub use schema::{
    CppBinaryOperator, CppCallArgument, CppExport, CppExpression, CppFunction,
    CppFunctionReference, CppInitializer, CppPlace, CppPlaceReference, CppProfile, CppSpan,
    CppStatement, CppType,
};
