...
```expect
fail: `f.contract` tactic 0: `step()` could not verify C operation: stable-view a required resource overlaps a live borrowed footprint refused during planning; selected resource `owns global:g@0[0..1]`
```
