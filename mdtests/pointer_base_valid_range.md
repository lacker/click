# valid_range supports pointer-base segments

This checks that segment-form `valid_range` uses the same pointer-base syntax
...
```c filename=pointer_base_valid_range.c
...
```click
verifying "pointer_base_valid_range.c";
