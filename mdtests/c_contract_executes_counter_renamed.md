# Source and target resource parameter names are independent
...
contract Progress(counter: Counter()) for int32() {
    owns counter;
    requires counter.revision < 2147483647;
    ensures counter.revision > old(counter.revision);
    ensures result == 0;
}
