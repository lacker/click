# Struct callback fields retain their signature and dispatch known targets

```c filename=struct_function_pointer_field.c
...
```click
verifying "struct_function_pointer_field.c";
