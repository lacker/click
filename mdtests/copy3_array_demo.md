                ...
                both {
                    both {
                        arithmetic_certificate signed_int32 {
                            ...
                            interval_intersect 2, 3 (0) (2);
                            interval_atom (1) (1) (1);
                            interval_add_bounded 4, 5 (1) (3);
                            trivial => -1 <= 0;
                            add 0, 7 => (at(statement(3).entry, 0) + -1) <= (at(statement(3).entry, i) + 0);
                            affine_conclusion 8 6 => i >= 0;
                            conclusion 9;
                        }
                    } and {
                        arithmetic_certificate signed_int32 {
