# A false conclusion in a reachable inner case is rejected
...
```expect
fail: have body tactic 1: `simp` failed for `lift.contract`: simplified proposition was not true: int32 equality is false
```
