# Pure callback refinement preserves an exact resource and ownership interface

Behavioral variance applies to the pure clauses while the callback's resource
transition and owned footprint remain exact. Those exact parts are compared
