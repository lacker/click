...
| Borrow stability, resource transport and abstract callback ownership | Borrow stability landed (`docs/internals/stable-views.md`); resource transport and abstract callback ownership landed on 2026-09-15 (the contracts and callbacks note in `docs/internals/architecture.md`). Aggregate-shape coverage does not certify the stable-view implementation. |
