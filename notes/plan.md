...
| profiler-coverage.md | open | Two holes in the profiling story: the loop-invariant bundle path emits no class-tagged timings (~95% of the two slow tests is unattributed), and click-profile cannot profile mdtests at all |
