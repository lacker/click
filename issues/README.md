...
1. [Kill complete verifier process groups on timeout](bounded-runs-leave-orphan-verifiers.md).
...
7. [Make smart-search success imply certificate replay](smart-certificate-replay-consistency.md).
