...
coverage. The remaining proof-shape restrictions below are still open.
...
a scope inside a branch arm; a guarded composite's child exported through
`branch ensuring`; and a contract with a conditional requirement.
